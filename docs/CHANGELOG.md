...
| **Final** | Anchors + verifier + bounded revision + escalation, with deterministic checks carrying the headline claims and results reported separately for natural, adversarial and clean cases. | [`results/eval/trap-check.md`](../results/eval/trap-check.md), [`results/eval/anchor-verification.md`](../results/eval/anchor-verification.md) | **Source claim corrupted: baseline 2/4, workflow 0/4.** Anchor validity 124/124. The main contribution turned out to be the provenance layer rather than escalation — see below. |
